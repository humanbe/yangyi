...
* @author LJay
*/
public class JEDACasAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
   //~ Instance fields ================================================================================================
   private ServiceProperties serviceProperties;

   private String loginUrl;
   
   private String iamCasTicket;
   ...
   public final void commence(final HttpServletRequest servletRequest, final HttpServletResponse response,
       ...
       if(iamCasTicket != null) {
    	   redirectUrl += "&iamcaspticket=" + URLEncoder.encode(iamCasTicket, "UTF-8");
       }
	   ...
	   if(null == itemProvider){
		...
		for (SubItem subItem : subItemList) {
			if("IP".equalsIgnoreCase(subItem.getName().trim())) {
				this.loginUrl = subItem.getValue() + "/login";
			}
		}
//		System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$ createRedirectUrl ============" + this.loginUrl);
   ...
   protected void preCommence(final HttpServletRequest request, final HttpServletResponse response) {
	   Object iamcaspticket = request.getSession().getAttribute("iamcaspticket");
	   	if(iamcaspticket != null) {
	   		iamCasTicket = iamcaspticket.toString();
	   	} else {
	   		iamCasTicket = null;
	   	}
   }
