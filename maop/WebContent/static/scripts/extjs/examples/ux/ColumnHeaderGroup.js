    ...
    viewConfig: {
        initTemplates: function(){
            ...
            if(!ts.gcell){
                ...
                ts.gcell = new Ext.XTemplate('<td class="x-grid3-header" style="{style}">', '<div {tooltip} class="x-grid3-hd-inner x-grid3-hd-{id}" unselectable="on" style="{istyle}">', this.grid.enableHdMenu ? '<a class="x-grid3-hd-btn" href="#"></a>' : '', '{value}</div></td>');
            }
            this.templates = ts;
