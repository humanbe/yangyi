	...
	constructor : function(cfg) {// 构造方法
		...
		this.gridStore = new Ext.data.JsonStore( {
			...
			fields : ['aplCode', 'changeMonth', 'changeDate' , 'eapsCode', 'changeName', 
			             ...
			             'operationId', 'operation', 'operationTel', 
			             'maintainTomo', 
			             'reviewerId', 'reviewer', 'reviewerTel', 
			             'appA', 'appChangeId'],
			remoteSort : true,
			sortInfo : {
		...
		this.grid = new Ext.grid.GridPanel( {
			...
			columns : [ new Ext.grid.RowNumberer(), csm, 
				{header : '<fmt:message key="property.appsyscd" />', dataIndex : 'aplCode', sortable : true,renderer : this.envAppsys_Store},
				...
				{header : '<fmt:message key="property.operationId" />', dataIndex : 'operationId', sortable : true},
				{header : '<fmt:message key="property.operation" />', dataIndex : 'operation', sortable : true},
				{header : '<fmt:message key="property.operationTel" />', dataIndex : 'operationTel', sortable : true},
				{header : '<fmt:message key="property.maintainTomo" />', dataIndex : 'maintainTomo', sortable : true},
				{header : '<fmt:message key="property.reviewerId" />', dataIndex : 'reviewerId', sortable : true},
				{header : '<fmt:message key="property.reviewer" />', dataIndex : 'reviewer', sortable : true},
				{header : '<fmt:message key="property.reviewerTel" />', dataIndex : 'reviewerTel', sortable : true}
	  		],
		...
		// 设置基类属性
		AppChangeManageList.superclass.constructor.call(this, {
			layout : 'border',
			border : false,
