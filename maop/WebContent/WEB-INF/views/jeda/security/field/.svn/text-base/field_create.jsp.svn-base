...
<script type="text/javascript">
	//定义新建表单
	FieldCreateForm = Ext.extend(Ext.FormPanel, {
		tabIndex : 0,// Tab键顺序
		constructor : function(cfg) {// 构造方法
			Ext.apply(this, cfg);
			// 设置基类属性
			FieldCreateForm.superclass.constructor.call(this, {
				title : '<fmt:message key="title.form" />',
				labelAlign : 'right',
				buttonAlign : 'center',
				frame : true,
				autoScroll : true,
				url : '${ctx}/${frameworkPath}/field/create',
				defaults : {
					anchor : '80%',
					msgTarget : 'side'
				},
	...
	app.window.get(0).add(new FieldCreateForm());
