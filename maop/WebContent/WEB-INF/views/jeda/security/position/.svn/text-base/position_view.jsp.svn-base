...
<script type="text/javascript">
	//定义编辑表单
	PositionViewForm = Ext.extend(Ext.FormPanel, {
		tabIndex : 0,// Tab键顺序
		...
		constructor : function(cfg) {// 构造方法
			...
			// 设置基类属性
			PositionViewForm.superclass.constructor.call(this, {
		...
		// 关闭操作
		doClose : function() {
			app.closeTab('POSITION_VIEW');
		}
	});

	// 实例化表单,并加入到Tab页中
	Ext.getCmp("POSITION_VIEW").add(new PositionViewForm());
	// 刷新Tab页布局
	Ext.getCmp("POSITION_VIEW").doLayout();
</script>
