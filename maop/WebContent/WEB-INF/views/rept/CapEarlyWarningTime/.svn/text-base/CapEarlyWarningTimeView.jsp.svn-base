...
CapEarlyWarningTimeViewForm = Ext.extend(Ext.FormPanel, {
	tabIndex : 0,// Tab键顺序
	constructor : function(cfg) {// 构造方法
		Ext.apply(this, cfg);
		
		// 设置基类属性		CapEarlyWarningTimeViewForm.superclass.constructor.call(this, {
	...
	// 关闭操作
	doClose : function() {
		app.closeTab('view_CapEarlyWarningTime');
	},
	// 数据加载失败回调
...
// 实例化新建表单,并加入到Tab页中
Ext.getCmp("view_CapEarlyWarningTime").add(new CapEarlyWarningTimeViewForm());
// 刷新Tab页布局
Ext.getCmp("view_CapEarlyWarningTime").doLayout();
</script>