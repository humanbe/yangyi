...
WeblogicConfManageEditForm = Ext.extend(Ext.FormPanel, {
	tabIndex : 0,// Tab键顺序	constructor : function(cfg) {// 构造方法		Ext.apply(this, cfg);
		// 设置基类属性		WeblogicConfManageEditForm.superclass.constructor.call(this, {
	...
	// 取消操作
	doCancel : function() {
		app.closeTab('edit_WeblogicConfManage');
	},
	// 保存成功回调
...
// 实例化新建表单,并加入到Tab页中
Ext.getCmp("edit_WeblogicConfManage").add(new WeblogicConfManageEditForm());
// 刷新Tab页布局
Ext.getCmp("edit_WeblogicConfManage").doLayout();
</script>