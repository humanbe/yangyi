...
TranInfoEditForm = Ext.extend(Ext.FormPanel, {
	tabIndex : 0,// Tab键顺序
	constructor : function(cfg) {// 构造方法
		Ext.apply(this, cfg);
		
		// 设置基类属性
		TranInfoEditForm.superclass.constructor.call(this, {
...
// 实例化新建表单,并加入到Tab页中
Ext.getCmp("edit_TranInfo").add(new TranInfoEditForm());
// 刷新Tab页布局
Ext.getCmp("edit_TranInfo").doLayout();
</script>